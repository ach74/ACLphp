...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="page">
            ...
            ?>
            <?php if (isset($_GET['action']) && $_GET['action'] == 'roles') { ?>
            ...
            <?php } ?>
            <?php
            if (isset($_GET['action']) && $_GET['action'] == 'perms') {
                ?>
                ...
                <form action="users.php" method="post">
                    <table border="0" cellpadding="5" cellspacing="0">
                        ...
                        foreach ($aPerms as $k => $v) {
                            ...
                            echo "Hola";
                            echo "<option value=\"0\"";
                            if ( isset($rPerms[$v['Key']]['value']) && $rPerms[$v['Key']]['value'] === false && $rPerms[$v['Key']]['inheritted'] != true) {
                                echo " selected=\"selected\"";
                            }
                            echo ">Deny</option>";
                            echo "<option value=\"x\"";
                            if (isset($rPerms[$v['Key']]['value']) && $rPerms[$v['Key']]['inheritted'] == true || !array_key_exists($v['Key'], $rPerms)) {
                                echo " selected=\"selected\"";
